...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, AdapterView.OnItemClickListener {
        ...
        if (id == CONTACT_LOAD) {
            ...
            mCursorLoader = new CursorLoader(MainActivity.this,
                    ...
                    ContactsContract.CommonDataKinds.Phone.TYPE_MOBILE
                            + " AND " +
                            ContactsContract.CommonDataKinds.Phone.HAS_PHONE_N
                    UMBER + "=1",
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (loader.getId() == CONTACT_LOAD) {
            ...
            if (data.moveToFirst()) {
                contactNumber = data.getString(data.getColumnIndex(ContactsCon
                        tract.CommonDataKinds.Phone.NUMBER));
            }
            if (PermissionManager.isGranted(this, Manifest.permission.CALL_PHO
                    NE)) {
